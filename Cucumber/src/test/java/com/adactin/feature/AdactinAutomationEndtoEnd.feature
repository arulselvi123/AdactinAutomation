...
@TC-15
Scenario Outline: To verify whether the booked itinerary details are not editable.
Given User launch the AdactIn Hotel Reservation application using URL as in the test data
When User enter the User-name in the welcome page
And User enter the Password in the welcome page 
And User click on the Login button
...
@TC-18
Scenario Outline: To Verify that all the details of newly generated order number in booked itinerary page are correct and match with data during booking.
Given User launch the AdactIn Hotel Reservation application using URL as in the test data
When User enter the User-name in the welcome page
And User enter the Password in the welcome page 
And User click on the Login button
...
And User clicks the book now button
And User clicks the My Itinerary button
And User search for OrderID '<Order No>'
Then User Verify all the details of order number are correct as entered during saving order

Examples:
|Hotel Name   |Location|Room Type	|Order No|
|"Hotel Creek"|"Sydney"|"Standard"|"STJ413Y3ZX"|
...
And User clicks the My Itinerary button
And User search for OrderID '<Order No>'
And User click on Cancel Selected button
And  User Click Yes on pop-up which asks where to cancel order or not  
...
@TC-20
Scenario Outline: To Verify Title of every Page reflects what the page objective is. For example Title of Search Hotel page should have “Search Hotel”
Given User launch the AdactIn Hotel Reservation application using URL as in the test data
When User enter the User-name in the welcome page
And User enter the Password in the welcome page 
And User click on the Login button
Then User verify Title of each page should reflect its objective and the buttons should redirect as specified, to the relevant page.
